   ...
   describe(".ApplyEffect with empty effect", function() {
    ...
    describe(".ApplyEffect with missing effect value", function() {
        it("should throw an exception for a missing effect value", function(){
            (function(){
                var validGame = { Id: 1};
                var invalidEffect = {Type: "Restore Stamina"};
                effect.applyEffect(validGame, invalidEffect);
    ...
    describe(".ApplyEffect with target player with 3 original stamina, 3 stamina data and a +2 buff", function() {
        it("should result in the target player having 5 stamina", function(){
            ...
            validGame.HomeTeam.Pitch[0].IsWarmingUp = true;
            validGame.HomeTeam.Pitch[1].Id = 2;
            validGame.HomeTeam.Pitch[1].Cost = 2;
            validGame.HomeTeam.Pitch[1].IsWarmingUp = true;
            validGame.HomeTeam.Pitch[1].Stamina = 3;
            validGame.HomeTeam.Pitch[1].OriginalStamina = 3;
            var validEffect = {};
            validEffect.Type = "Restore Stamina";
            validEffect.Target = 2;
            validEffect.Value = 2;
            validEffect.TeamId = 1;
            var modifiedGame = effect.applyEffect(validGame, validEffect);
            modifiedGame.HomeTeam.Pitch[1].should.have.property('Stamina', 3);
        });
    });
    ...
    describe(".ApplyEffect with target player with 3 original stamina, 2 stamina data and a +2 buff", function() {
        it("should result in the target player having 3 stamina", function(){
            ...
            validGame.HomeTeam.Pitch[1].Cost = 2;
            validGame.HomeTeam.Pitch[1].IsWarmingUp = true;
            validGame.HomeTeam.Pitch[1].Stamina = 2;
            validGame.HomeTeam.Pitch[1].OriginalStamina = 3;
            var validEffect = {};
            validEffect.Type = "Restore Stamina";
            validEffect.Target = 2;
    ...
    describe(".ApplyEffect with target player with 3 original stamina, 1 stamina and a +2 buff", function() {
       it("should result in the target player having 3 stamina", function(){
           ...
           validGame.HomeTeam.Pitch[1].Cost = 2;
           validGame.HomeTeam.Pitch[1].IsWarmingUp = true;
           validGame.HomeTeam.Pitch[1].Stamina = 1;
           validGame.HomeTeam.Pitch[1].OriginalStamina = 3;
           var validEffect = {};
           validEffect.Type = "Restore Stamina";
           validEffect.Target = 2;
    ...
    describe(".ApplyEffect (Away Team) with target player with 3 original stamina, 1 stamina and a +2 buff", function() {
        it("should result in the target player having 3 stamina", function(){
            ...
            validGame.AwayTeam.Pitch[0].Id = 1;
            validGame.AwayTeam.Pitch[0].Cost = 2;
            validGame.AwayTeam.Pitch[0].IsWarmingUp = true;
            validGame.AwayTeam.Pitch[1].Id = 2;
            validGame.AwayTeam.Pitch[1].Cost = 2;
            validGame.AwayTeam.Pitch[1].IsWarmingUp = true;
            validGame.AwayTeam.Pitch[1].Stamina = 1;
            validGame.AwayTeam.Pitch[1].OriginalStamina = 3;
            var validEffect = {};
            validEffect.Type = "Restore Stamina";
            validEffect.Target = 2;
            validEffect.Value = 2;
            ...
            var modifiedGame = effect.applyEffect(validGame, validEffect);
            modifiedGame.AwayTeam.Pitch[1].should.have.property('Stamina', 3);
        });
    });
